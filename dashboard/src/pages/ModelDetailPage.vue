...
import { formatNumber, formatTimestamp } from '../composables/useFormatters'
...
<template>
  <div class="space-y-6">
    <router-link to="/models" class="text-sm text-dfpn-primary-light hover:underline">&larr; Back to Models</router-link>
