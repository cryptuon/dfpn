...
import { useNetworkStore, type NetworkName } from '../../stores/network'
...
<template>
  <header class="h-16 border-b border-dfpn-border bg-dfpn-surface/80 backdrop-blur-sm flex items-center justify-between px-6 sticky top-0 z-20">
    <div class="flex items-center gap-4">
      <h1 class="text-lg font-semibold text-white">Deepfake Proof Network</h1>
    </div>
