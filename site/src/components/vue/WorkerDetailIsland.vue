...
import { formatReputation, formatNumber, successRate } from '@dashboard/composables/useFormatters'
...
<template>
  <div class="space-y-6">
    <a href="/workers" class="text-sm text-dfpn-primary-light hover:underline">&larr; Back to Workers</a>
